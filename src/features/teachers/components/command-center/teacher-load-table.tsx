        ...
        <thead>
          <tr className="border-b border-border bg-muted/50">
            <th
              role="columnheader"
              scope="col"
              className="px-4 py-2.5 text-left text-xs font-semibold text-(--ssz-text-muted) uppercase tracking-wide"
            >
              {t("name")}
            </th>
            <th
              role="columnheader"
              scope="col"
              className="px-4 py-2.5 text-left text-xs font-semibold text-(--ssz-text-muted) uppercase tracking-wide w-40"
            >
              {t("load")}
            </th>
            <th
              role="columnheader"
              scope="col"
              className="hidden md:table-cell px-4 py-2.5 text-left text-xs font-semibold text-(--ssz-text-muted) uppercase tracking-wide"
            >
              {t("langs")}
            </th>
            <th
              role="columnheader"
              scope="col"
              className="hidden sm:table-cell px-4 py-2.5 text-center text-xs font-semibold text-(--ssz-text-muted) uppercase tracking-wide w-20"
            >
              {t("groups")}
            </th>
            <th
        ...
        <tbody>
          {teachers.map((teacher) => (
            <tr
              ...
              tabIndex={0}
              className="border-b border-border last:border-0 hover:bg-accent/50 cursor-pointer transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-inset"
            >
              ...
              <td role="gridcell" className="hidden md:table-cell px-4 py-3">
              ...
              <td role="gridcell" className="hidden sm:table-cell px-4 py-3 text-center text-(--ssz-text-secondary)">
                {teacher.groupCount}
              </td>
              <td role="gridcell" className="hidden sm:table-cell px-4 py-3 text-center">
