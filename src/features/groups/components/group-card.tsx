...
import { AlertArea, LangBadge, TeacherStack } from './group-health-row';
 ...
 */
export async function GroupCard({ group, href }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-start gap-2">
        ...
        <ChevronRight className="size-4 text-(--ssz-text-muted) shrink-0 mt-0.5" aria-hidden="true" />
      </div>
